...
enum pon_restart_reason {
	...
	PON_RESTART_REASON_REBOOT		= 0x07, // reboot
#endif
	/* 32 ~ 63 for OEMs/ODMs secific features */
	PON_RESTART_REASON_OEM_MIN		= 0x20,
	#ifdef CONFIG_ODM_WT_EDIT
	PON_RESTART_REASON_ODM_WLAN		= PON_RESTART_REASON_OEM_MIN,
	PON_RESTART_REASON_ODM_RF		= 0x21,
	PON_RESTART_REASON_ODM_FTM		= 0x22,
	PON_RESTART_REASON_ODM_KERNEL	= 0x23,
	PON_RESTART_REASON_ODM_MODEM	= 0x24,
