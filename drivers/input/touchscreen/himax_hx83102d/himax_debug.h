...
#define HIMAX_PROC_DEBUG_INFO_FILE	"debug_info"
struct proc_dir_entry *himax_proc_dbg_info_dir = NULL;
#define HIMAX_PROC_DELTA_FILE	"delta"
struct proc_dir_entry *himax_proc_delta_file = NULL;
#define HIMAX_PROC_BASELINE_FILE	"baseline"
struct proc_dir_entry *himax_proc_baseline_file = NULL;
