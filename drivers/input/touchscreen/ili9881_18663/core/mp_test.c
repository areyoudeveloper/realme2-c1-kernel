...
static void mp_calc_nodp(bool long_v)
{
	...
	ipio_debug(DEBUG_MP_TEST, "DDI Mode = %d\n", long_v);
...
int core_mp_calc_timing_nodp(void)
{
	...
	ipio_debug(DEBUG_MP_TEST, "60HZ = %d\n",core_mp->nodp.is60HZ);
	ipio_debug(DEBUG_MP_TEST, "DDI Mode = %d\n",core_mp->nodp.isLongV);
	ipio_debug(DEBUG_MP_TEST, "TSHD = %d\n",core_mp->nodp.tshd);
	ipio_debug(DEBUG_MP_TEST, "Multi Term Num (120Hz) = %d\n",core_mp->nodp.multi_term_num_120);
	ipio_debug(DEBUG_MP_TEST, "Multi Term Num (60Hz) = %d\n",core_mp->nodp.multi_term_num_60);
	ipio_debug(DEBUG_MP_TEST, "TSVD to TSHD = %d\n",core_mp->nodp.tsvd_to_tshd);
	ipio_debug(DEBUG_MP_TEST, "QSH TDF = %d\n",core_mp->nodp.qsh_tdf);
	ipio_debug(DEBUG_MP_TEST, "AutoTrim Variation = %d\n",core_mp->nodp.auto_trim);
	ipio_debug(DEBUG_MP_TEST, "TP TSHD Wait (120Hz) = %d\n",core_mp->nodp.tp_tshd_wait_120);
	ipio_debug(DEBUG_MP_TEST, "DDI Width (120Hz) = %d\n",core_mp->nodp.ddi_width_120);
	ipio_debug(DEBUG_MP_TEST, "TP TSHD Wait (60Hz) = %d\n",core_mp->nodp.tp_tshd_wait_60);
	ipio_debug(DEBUG_MP_TEST, "DDI Width (60Hz) = %d\n",core_mp->nodp.ddi_width_60);
	ipio_debug(DEBUG_MP_TEST, "DP to TP = %d\n",core_mp->nodp.dp_to_tp);
	ipio_debug(DEBUG_MP_TEST, "TX Wait Const = %d\n",core_mp->nodp.tx_wait_const);
	ipio_debug(DEBUG_MP_TEST, "TX Wait Const Multi = %d\n",core_mp->nodp.tx_wait_const_multi);
	ipio_debug(DEBUG_MP_TEST, "TP to DP = %d\n",core_mp->nodp.tp_to_dp);
	ipio_debug(DEBUG_MP_TEST, "Phase ADC = %d\n",core_mp->nodp.phase_adc);
	ipio_debug(DEBUG_MP_TEST, "R2D PW = %d\n",core_mp->nodp.r2d_pw);
	ipio_debug(DEBUG_MP_TEST, "RST PW = %d\n",core_mp->nodp.rst_pw);
	ipio_debug(DEBUG_MP_TEST, "RST PW Back = %d\n",core_mp->nodp.rst_pw_back);
	ipio_debug(DEBUG_MP_TEST, "DAC TD = %d\n",core_mp->nodp.dac_td);
	ipio_debug(DEBUG_MP_TEST, "QSH PW = %d\n",core_mp->nodp.qsh_pw);
	ipio_debug(DEBUG_MP_TEST, "QSH TD = %d\n",core_mp->nodp.qsh_td);
	ipio_debug(DEBUG_MP_TEST, "Drop NODP Num = %d\n",core_mp->nodp.drop_nodp);
